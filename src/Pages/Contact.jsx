  ...
  return (
    <div className="flex w-full flex-col relative items-center mt-3 h-full">
      ...
      <div className="w-full h-[823px]">
        <h1 className='text-3xl md:text-4xl text-gray-800 font-bold mt-9 text-center'>
          Welcome to <span className='text-4xl font-bold text-red-600 cursor-pointer'>SENƎX</span>
        </h1>
        <p className="text-lg mb-6 font-semibold text-gray-800 mt-2 text-center">Find us here:</p>
      ...
      <div className=' h-full w-full relative mb-10 grid justify-center grid-cols-1 md:grid-cols-2 mt-6 sm:mt-10 md:mt-16'>
        ...
        <div className='border-r-2'>
          <div className='mx-auto w-[80%]'>
            <h1 className='text-4xl font-bold mb-3 text-gray-800 underline '>Send Us a Message</h1>
        ...
        <div className='mt-16 md:mt-0'>
          <div className='mx-auto w-[80%]'>
            <h1 className='text-4xl font-bold mb-5 text-gray-800 underline'>Our Store</h1>
            <div className='w-full'>
              <div>
                <h1 className='text-gray-800 text-xl font-semibold'>Address</h1>
                <p className='text-gray-800 mt-2'>No 29 UC Shipping Complex<br/>Ja-Ela 11350<br/>Sri Lanka</p>
              </div>
              <div className='text-gray-800 mt-8 md:mt-4'>
                <h1 className='text-gray-800 text-xl font-semibold mb-2'>Customer Support</h1>
                <p>HotLine: 0777-300-288</p>
                <p>Showroom: 011-446-8500</p> 
                <p>Workshop: 011-467-3950 / 011-419-9941</p>
                <p>Email: msds.net@live.com</p>
              </div>
              <div className='text-gray-800 md:w-[50%] mt-8 md:mt-4'>
                <h1 className='text-gray-800 text-xl mb-2 font-semibold'>Hours of Operation</h1>
