      ...
      <div className='w-full h-full absolute z-10'>
        ...
        <div className='w-full flex mx-auto mt-16 md:mt-20 lg:mt-28 xl:mt-32 mxl:mt-10 2xl:mt-32 bg-black/50 xl:bg-transparent relative'>
          <div className='mx-auto float-up w-[80%]'>
            <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold xl:mt-10 text-gray-800 drop-shadow-xl uppercase text-center'>About Us</h1>
            <p className='mt-5 lg:mt-10 text-gray-800 font-semibold drop-shadow-xl leading-loose text-center'>Welcome to our online store, where we provide high quality merchandise at unbeatable prices.<br/>Our customer service is unmatched, and that we stock all the newest and greatest items on store.</p>
            <p className='mt-5 lg:mt-10 text-gray-800 font-semibold drop-shadow-xl leading-loose text-center'>We are a well renowned store in providing wholesale & retail products that has continually featured <br/> a variety of high quality and affordable products since day one.</p>
            <p className='mt-5 lg:mt-10 text-gray-800 font-semibold drop-shadow-xl leading-loose text-center'>Our passion for excellence has driven us from the beginning, and continues to drive us in the future creating<br/> a line perfect for individuals. The team at Microsis knows that every product counts, and strives to make the entire<br/> shopping experience as rewarding and fun as possible.</p>
          </div>
        </div>
      </div>
