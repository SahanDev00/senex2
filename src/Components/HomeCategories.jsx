  ...
  return (
    <div className='w-[95%] h-full relative border-red-500 rounded-xl mx-auto justify-center items-center flex '>
        <div className='w-full'>
            <p className='flex justify-center uppercase text-sm font-semibold mt-5 font-mono'>Products</p>
            <h1 className='text-3xl lg:text-4xl flex justify-center font-bold font-poppins'>SHOP BY CATEGORY</h1>
