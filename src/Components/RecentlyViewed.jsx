...
const RecentlyViewed = () => {
  ...
  return (
    <div className='w-[95%] flex mx-auto mt-16 relative border-gray-500 items-center rounded-xl justify-center'>
      <div className='w-[95%] h-[95%]'>
      {/*<p className='flex justify-center uppercase text-sm font-semibold  mt-5 font-mono'>RECOMMENDED FOR YOU</p>*/}
        <h1 className='font-semibold text-2xl sm:text-3xl text-center  font-poppins'>RECOMMENDED FOR YOU</h1>
