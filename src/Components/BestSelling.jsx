...
const BestSelling = () => {
  ...
  return (
    <div className='w-[95%] flex mx-auto mt-16 relative border-gray-500 items-center rounded-xl justify-center'>
      ...
      {/*<p className='flex justify-center uppercase text-sm font-semibold  mt-5 font-mono'>Top Products</p>*/}
        <h1 className='font-semibold text-2xl sm:text-3xl text-center  font-poppins'>BEST SELLING ITEMS</h1>
