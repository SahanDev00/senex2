...
const EditProfile = () => {
  return (
    <div className='relative container mx-auto'>
      <div>
        <h1 className='text-3xl text-gray-800 mt-5 font-bold text-center font-poppins'>Edit Your Details</h1>
              <form className='mt-3 mb-10'>
                <div className='flex gap-4 w-[80%] mx-auto'>
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>First Name</label>
                  ...
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>Last Name</label>
                ...
                <div className='flex gap-4 w-[80%] mx-auto'>
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>Address Line 1</label>
                  ...
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>Address Line 2</label>
                    <input className='block w-full mx-auto rounded-lg pl-4 py-1 border-red-500 border-2 mb-2 mt-1' type="text" placeholder='' required />
                  </div>
                </div>
                <div className='flex gap-4 w-[80%] mx-auto'>
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>City</label>
                    <input className='block w-full mx-auto rounded-lg pl-4 py-1 border-red-500 border-2 mb-2 mt-1' type="text" placeholder='' required />
                  </div>
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>State</label>
                    <input className='block w-full mx-auto rounded-lg pl-4 py-1 border-red-500 border-2 mb-2 mt-1' type="text" placeholder='' required />
                  </div>
                </div>
                <div className='flex gap-4 w-[80%] mx-auto'>
                  <div className='w-full'>
                    <label className='font-semibold text-sm text-gray-800 font-poppins'>Postal Code</label>
                ...
                <div className='w-[80%] mx-auto'>
                  <label className='font-semibold text-sm text-gray-800 font-poppins'>Mobile Number</label>
                ...
                <div className='w-[80%] mx-auto'>
                  <label className='font-semibold text-sm text-gray-800 font-poppins'>Email</label>
